...
<p> Your Balance is: {usern.Balance}</p>
   ...
   <div>
    <h2>Sendmoney</h2>
    <form>
      <input type='number' placeholder='enter receiver ACC' className='p-1 border-1 md:w-100 lg:w-45 m-1 sm:w-120 w-75 rounded-lg' required onChange={(e)=>(setReceiverAccount(e.target.value))} />
      <input type='number' placeholder='enter Amount' className='p-1 border-1 md:w-100 lg:w-45 sm:w-120 w-75 rounded-lg' required onChange={(e)=>(setAmount(e.target.value))} />
